...
\begin{defi}{\textbf{(Brücke)}}\newline
Sei ein Graph $G=(V,E)$ gegeben.\newline
\end{defi}

\begin{defi}{\textbf{(Trennungsknoten/ Separationsknoten)}}\newline
Sei ein Graph $G=(V,E)$ gegeben.\newline
\end{defi}
...
\end{bem}
\subsection{Kontraktion und Erweiterung}
\subsection{Laufzeit und $\mathcal{NP}$-Vollständigkeit}
\newpage
...
Es gibt vier Arten von bekannten Ergebnissen zur metrischer Dimension. Neben Graph-\\klassen mit einem konstanten Wert, wie z.B. bei Kreisen $C_n$ mit $n\geq 3$ und $md(C_n)=2$, gibt es auch Graphklassen mit parameterabhängiger metrischer Dimension wie z.B. die vollständigen Graphen $K_n$ mit $n \geq 1$ und $md(K_n)=n-1$.\newline Bei manchen Klassen kann die metrische Dimension algorithmisch bestimmt werden, Beispiele dafür sind Bäumen oder außenplanare Graphen\cite{aussenplanar}.\newline
...
Es seien mehrere Graphen mit bekannter metrische Dimension gegeben.\newline Welche Aussagen bezüglich metrischer Dimension lassen sich über unterschiedliche Kompositionen oder Teilgraphen von diesen Graphen formen?\\Dieser Abschnitt widmet sich der Vereinigung und dem kartesischen Produkt, bei werden alle Knoten an der Komposition beteiligt, und dem Corona Produkt, bei welchem ein Graph kopiert und mit jedem Knoten des anderen Graphen verbunden wird.
...
Die Teilgraphen und die Graphklasse für die Überprüfung wurden einzelnd in den Kapitel zuvor untersucht. Außerdem wurde ein weitere Graphklasse eingeführt, wessen metrische Dimension mit Hilfe des Algorithmus berechnet werden kann.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
