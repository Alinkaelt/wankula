...
% Die Arbeit gliedert sich in vier Teile. Zunächst gibt eine Einführung in die Termininologie von Graphentheorie und metrischer Dimension und bekannte Ergebnisse über die metrische Dimension werden dargestellt. Dann werden verschiedene Eigenschaften von Graphen bezüglich metrischer Dimension bewiesen und zwei besondere Graphklassen, die Freundschafts- und Sonnengraphen auf unterschiedliche Arten untersucht. Anschließend wird detailiert auf den Algorithmus zur Berechnung der Kaktusgraphen eingegangen inklusive seiner Laufzeit und Korrektheit. Im Schluss wird er mit anderen Algorithmen zur Berechnung der metrischen Dimension verglichen und es wird eine Graphklasse, die $C_j$-Bäume, eingeführt und analysiert.
%\end{itemize}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
Für $n=1$ ist der Graph der Sterngraph aus Definition \ref{defstern}. Als Sonnengraph $S_n$ bezeichne man einen Graphen mit $n$ Strahlen beliebiger Länge $i$ mit $i \geq 2$. Ist $n=2m+3$ mit $m \in \mathbb{N}$ so nennt man den Sonnengraphen ungerade, ist $n=2m+2$ mit $m \in \mathbb{N}^+$ so bezeichnet man den Sonnengraphen als gerade.
\end{defi}
\begin{figure}[h!]
\centering
